...
-- Records of wisata
-- ----------------------------
INSERT INTO `wisata` VALUES (1, 1, 'Bukit Arosbaya', 'Formasi batu kapur dan pemandangan alam yang indah, populer untuk hiking ringan.', 'Arosbaya, Bangkalan', NULL, NULL, -6.9474130, 112.8595340);
INSERT INTO `wisata` VALUES (2, 1, 'Bukit Jaddih', 'Bukit kapur dengan pemandangan tebing kapur yang unik dan spot foto menarik.', 'Socah, Bangkalan', NULL, NULL, -7.0822830, 112.7595400);
INSERT INTO `wisata` VALUES (3, 1, 'Bukit Geger', 'Bukit dengan area perbukitan dan pemandangan laut dari ketinggian.', 'Geger, Bangkalan', NULL, NULL, -7.0288890, 112.9330560);
INSERT INTO `wisata` VALUES (4, 2, 'Pantai Rongkang', 'Pantai dengan batu-batu besar dan pemandangan ombak yang dramatis.', 'Kwanyar, Bangkalan', NULL, NULL, -7.1644380, 112.8419530);
INSERT INTO `wisata` VALUES (5, 2, 'Pantai Siring Kemuning', 'Pantai dengan pasir putih dan lokasi yang cocok untuk piknik keluarga.', 'Tanjung Bumi, Bangkalan', NULL, NULL, -6.8849340, 113.0527800);
INSERT INTO `wisata` VALUES (6, 2, 'Pantai Rindu', 'Pantai populer dengan pemandangan laut yang luas dan area rekreasi.', 'Labang, Bangkalan', NULL, NULL, -7.1606870, 112.7744520);
INSERT INTO `wisata` VALUES (7, 2, 'Pantai Goa Petapa', 'Pantai dengan goa dan spot snorkeling kecil.', 'Labang, Bangkalan', NULL, NULL, -7.1576460, 112.8023530);
...
INSERT INTO `wisata_gambar` VALUES (8, 8, ' batu.jpg');
